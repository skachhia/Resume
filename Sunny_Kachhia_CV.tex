...
% A Full Stack engineer with over \textbf{8 years} of experience, including \textbf{5+ years} as a \textbf{Web Engineer} and \textbf{6+ years} as a \textbf{Java Software Engineer}, with a successful track record of delivering more than 5 projects. \\~\\

% While working at \textbf{Aindra}, I nurtured a keen interest in tech, focusing on building projects from scratch. My responsibilities included utilizing in-house \textbf{AI platforms} for tasks such as \textbf{face, text, object detection}, and \textbf{cervical cancer cell detection}.\\~\\
...
% After joining \textbf{Webonise Lab}, I discovered my passion for front-end technology and dedicated myself to becoming a React-specialized Full Stack Engineer. Progressing into a leadership role, I've actively participated in staffing and trained over 20 new recruits in React, Git, and the Spring framework.
